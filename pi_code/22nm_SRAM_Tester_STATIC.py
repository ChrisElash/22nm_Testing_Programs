...
GPIO.setup(31, GPIO.OUT, initial = GPIO.HIGH) # the enable for the sram clk this is for the static test
...
if __name__ == '__main__':
    ...
    print("                                                          ")
    time.sleep(0.5)
    print("Welcome to the 22nm FDSOI SRAM Tester STATIC\n")
    ...
    # now begin the waiting part
    # set the clk enable to be low so that sram is static and no longer active.
    GPIO.output(31, GPIO.LOW)

    # now begin the process of waiting
    testing_time = 48 * 60 * 60 # 48 hours
    print("The test is 0% complete")
    time.sleep(testing_time/10)
    print("The test is 10% complete")
    time.sleep(testing_time/10)
    print("The test is 20% complete")
    time.sleep(testing_time/10)
    print("The test is 30% complete")
    time.sleep(testing_time/10)
    print("The test is 40% complete")
    time.sleep(testing_time/10)
    print("The test is 50% complete")
    time.sleep(testing_time/10)
    print("The test is 60% complete")
    time.sleep(testing_time/10)
    print("The test is 70% complete")
    time.sleep(testing_time/10)
    print("The test is 80% complete")
    time.sleep(testing_time/10)
    print("The test is 90% complete")
    time.sleep(testing_time/10)
    print("The test is 100% complete")

    GPIO.output(31, GPIO.HIGH) # turn the clock back on

    time.sleep(2)
    print("Beginning to search for errors...")
    time.sleep(1)
