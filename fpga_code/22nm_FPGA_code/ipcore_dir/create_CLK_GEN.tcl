...
set result [ run_cg_create "xilinx.com:ip:pll_sw:13.1" "CLK_GEN" "Dynamically switch between input clock sources (PLL)" "Dynamically switch between input clock sources (PLL) (xilinx.com:ip:pll_sw:13.1) generated by Project Navigator" xc5vlx50-3ff1153 Verilog ]
